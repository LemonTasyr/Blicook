...
@section('container')
    ...
    @if ($posts->count())
        <div class="card mb-3">
            ...
            <div class="card-body">
                <h3 class="card-title text-center"><a href="/posts/{{ $posts[0]->slug }}"
                        class="text-decoration-none text-dark">{{ $posts[0]->title }}</a></h3>

                <p class="text-muted text-center">
                    By. <a href="/posts?author={{ $posts[0]->author->username }}" class= "text-decoration-none text-center">
                        {{ $posts[0]->author->name }}</a> in <a href="/posts?category={{ $posts[0]->category->slug }}"
                        class="text-decoration-none text-center">{{ $posts[0]->category->name }}</a>
